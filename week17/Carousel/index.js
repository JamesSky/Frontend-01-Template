...
export class Carousel {
  ...
  render () {
    const childViews = this.children.map((child, currentPosition) => {
      ...
      let prevPosition = (currentPosition - 1 + this.children.length) % this.children.length
      ...
      const onPanend = e => {
        ...
        this.position = (this.position - direction + this.children.length) % this.children.length
